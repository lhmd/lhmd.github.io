...
const meshSections = [
  {
    ...
    title: "DL3DV scenes",
    assets: [
      { group: "DL3DV", title: "DL3DV-389", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-09.ply.gz", viewMode: "top" },
      {
        group: "DL3DV",
        title: "DL3DV-98f",
      ...
      { group: "DL3DV", title: "DL3DV-826", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-08.ply.gz", viewMode: "top" },
      { group: "DL3DV", title: "DL3DV-374", src: "./assets/mesh/gallery-web/dl3dv/new_374_DIRECT_triangle_mesh.ply.gz", view: [0, 1] },
      { group: "DL3DV", title: "DL3DV-b7f", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-07.ply.gz", viewMode: "top" },
      ...
      { group: "DL3DV", title: "DL3DV-63f", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-10.ply.gz", viewMode: "top" },
      { group: "DL3DV", title: "DL3DV-779", src: "./assets/mesh/gallery-web/dl3dv/teaser.ply.gz", view: [0, 1] },
      { group: "DL3DV", title: "DL3DV-cb7", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-12.ply.gz", viewMode: "top" },
      { group: "DL3DV", title: "DL3DV-9c5", src: "./assets/mesh/gallery-web/dl3dv/new_9c5_DIRECT_triangle_mesh.ply.gz", view: [0, 1] },
      { group: "DL3DV", title: "DL3DV-f35", src: "./assets/mesh/gallery-web/dl3dv/additional/dl3dv-scene-11.ply.gz", viewMode: "top" },
    ],
  },
  {
    id: "re10k",
    title: "RE10K scenes",
    assets: [
      { group: "RE10K", title: "RE10K-1e5", src: "./assets/mesh/gallery-web/re10k/05_5907e099d74681e5_triangle_direct_q995.ply.gz" },
      { group: "RE10K", title: "RE10K-ff8", src: "./assets/mesh/gallery-web/re10k/10_7a874ba9dd12cff8_triangle_direct_q995.ply.gz", view: [0, 1] },
      { group: "RE10K", title: "RE10K-d14", src: "./assets/mesh/gallery-web/re10k/12_a46f4561a9bb6d14_triangle_direct_q995.ply.gz", viewFlip: true },
      { group: "RE10K", title: "RE10K-616", src: "./assets/mesh/gallery-web/re10k/20_6054a3584527a616_triangle_direct_q995.ply.gz" },
